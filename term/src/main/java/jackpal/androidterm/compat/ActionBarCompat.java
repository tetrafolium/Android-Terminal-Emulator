...
class ActionBarApi11OrLater extends ActionBarCompat {
  ...
  ActionBarApi11OrLater(final Object bar) { this.bar = (ActionBar)bar; }

  private ActionBar.OnNavigationListener
  wrapOnNavigationCallback(final OnNavigationListener callback) {
  ...
  public int getDisplayOptions() { return bar.getDisplayOptions(); }

  public int getHeight() { return bar.getHeight(); }

  public int getNavigationItemCount() { return bar.getNavigationItemCount(); }

  public int getNavigationMode() { return bar.getNavigationMode(); }

  public int getSelectedNavigationIndex() {
    return bar.getSelectedNavigationIndex();
  }

  public CharSequence getTitle() { return bar.getTitle(); }

  public void hide() { bar.hide(); }

  public boolean isShowing() { return bar.isShowing(); }
  ...
  public void setListNavigationCallbacks(final SpinnerAdapter adapter,
                                         final OnNavigationListener callback) {
    bar.setListNavigationCallbacks(adapter, wrapOnNavigationCallback(callback));
  }

  public void setNavigationMode(final int mode) { bar.setNavigationMode(mode); }

  public void setSelectedNavigationItem(final int position) {
    bar.setSelectedNavigationItem(position);
  }

  public void setTitle(final int resId) { bar.setTitle(resId); }

  public void setTitle(final CharSequence title) { bar.setTitle(title); }
