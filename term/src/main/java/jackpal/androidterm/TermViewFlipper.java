...
public class TermViewFlipper extends ViewFlipper implements Iterable<View> {
  ...
  class ViewFlipperIterator implements Iterator<View> {
    ...
    public boolean hasNext() { return (pos < getChildCount()); }

    public View next() { return getChildAt(pos++); }
  ...
  public Iterator<View> iterator() { return new ViewFlipperIterator(); }
  ...
  private void showTitle() {
    ...
    String title =
        context.getString(R.string.window_title, getDisplayedChild() + 1);
