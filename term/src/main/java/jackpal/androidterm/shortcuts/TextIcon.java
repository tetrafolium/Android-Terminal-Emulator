...
{
  ////////////////////////////////////////////////////////////
  public static Bitmap getTextIcon(final String text, final int color, final int width, final int height)
  {
    text =   text.trim();
    ...
    int     wBitmap = (int) W;
    if (W < f) {
        wBitmap = (int) FloatMath.ceil(f); hBitmap = (int) FloatMath.ceil(H);
    } else    {
        wBitmap = (int) FloatMath.ceil(W); hBitmap = (int) FloatMath.ceil(height * wBitmap / width);
    }
