       ...
       implements CompoundButton.OnCheckedChangeListener
{
  ...
  ////////////////////////////////////////////////////////////
  public ColorValue(final Context context, final ImageView imgview, final String result[])
  {
    ...
    for (int i = 0; i < arraySizes; i++)
    {
      ...
      sb[i].setOnSeekBarChangeListener(
        new SeekBar.OnSeekBarChangeListener()
        {
          ...
          private void doProgressChanged(final SeekBar seekBar, final int progress, final boolean fromUser)
          {
            if (fromUser && started)
            {
