  ...
  private LinearLayout directoryEntry(final String name)
  {
    ...
    } else
    {
      if (countDirectoryView < cachedDirectoryView.size()) {
          ...
          ll = directoryView(up); cachedDirectoryView.put(countDirectoryView, ll);
      }
      ++countDirectoryView;
    }
...
, android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT
  ...
  private void makeView()
  {
    ...
    String zd[] = cd.list(new java.io.FilenameFilter() { public boolean accept(final File file, final String name) {
    ...
    String zf[] = cd.list(new java.io.FilenameFilter() { public boolean accept(final File file, final String name) {
        return (!(new File(file, name).isDirectory())); }});
    if (zf != null)
    {
