...
public class FSNavigator extends android.app.Activity {
  ...
  ////////////////////////////////////////////////////////////
  private void doResume() { makeView(); }
  ////////////////////////////////////////////////////////////
  private void swapTheme() {
    ...
    startActivityForResult(
        getIntent().addFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT), -1);
    finish();
  }
  ////////////////////////////////////////////////////////////
  private String ifAvailable(final String goTo) {
    if (goTo.startsWith(extSdCard)) {
      ...
      toast(getString(R.string.fsnavigator_no_external_storage),
            1); //"External storage not available", 1);
      return (extSdCard);
    }
    return (goTo);
  }
  ////////////////////////////////////////////////////////////
  private File chdir(final File file) {
    String path = ifAvailable(getCanonicalPath(file));
    System.setProperty("user.dir", path);
    return (cd = new File(path));
  }
  private File chdir(final String path) { return (chdir(new File(path))); }
  ////////////////////////////////////////////////////////////
  private TextView entryDividerH() {
    ...
    if (countDividerView < cachedDividerView.size()) {
      ...
      tv.setLayoutParams(new LinearLayout.LayoutParams(
          LinearLayout.LayoutParams.FILL_PARENT, 1, 1));
  ...
  View.OnClickListener fileListener = new View.OnClickListener() {
    public void onClick(final View view) {
      ...
      if (path != null) {
        setResult(RESULT_OK,
                  getIntent().setData(Uri.fromFile(new File(cd, path))));
        finish();
      }
    }
  };
  ////////////////////////////////////////////////////////////
  private LinearLayout fileView(final boolean entryWindow) {
    ...
    if (entryWindow) {
      ...
      hv.setLayoutParams(new LinearLayout.LayoutParams(
          LinearLayout.LayoutParams.FILL_PARENT, BUTTON_SIZE, 7));
      hv.addView(tv);
      ll.addView(hv);
    }
  ...
  private LinearLayout fileEntry(final String entry) {
    ...
    if (entry == null)
      ...
      if (countFileView < cachedFileView.size())
        ll = cachedFileView.get(countFileView);
      else
        cachedFileView.put(countFileView, ll = fileView(entry == null));
      ++countFileView;
    }
  ...
  ////////////////////////////////////////////////////////////
  private ImageView imageViewFolder(final boolean up) {
  ...
  ////////////////////////////////////////////////////////////
  private LinearLayout directoryView(final boolean up) {
    ImageView b1 = imageViewFolder(up);
    TextView tv = new TextView(context);
    if (up)
      tv.setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT); // Gravity.CENTER);
    else
      tv.setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
    tv.setClickable(true);
    tv.setLongClickable(true);
    ...
    tv.setLayoutParams(new LinearLayout.LayoutParams(
        LinearLayout.LayoutParams.FILL_PARENT, BUTTON_SIZE, 1));
    HorizontalScrollView hv = new HorizontalScrollView(context);
    hv.addView(tv);
    hv.setFillViewport(true);
    ...
    LinearLayout ll = new LinearLayout(context);
    ll.setLayoutParams(new LinearLayout.LayoutParams(
        LinearLayout.LayoutParams.FILL_PARENT, BUTTON_SIZE, 2));
    ll.setOrientation(LinearLayout.HORIZONTAL);
    ll.setGravity(android.view.Gravity.FILL);
  ...
  private LinearLayout makeContentView() {
    ...
    bg.setTag(ll);
    bg.addView(titleView, android.view.ViewGroup.LayoutParams.FILL_PARENT,
               android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
    bg.addView(sv);
    bg.addView(pathEntryView, android.view.ViewGroup.LayoutParams.FILL_PARENT,
               android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
    return (bg);
  }
  ////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////
  java.util.Comparator<String> stringSortComparator =
  ...
  //////////////////////////////////////////////////////////////////////
  String getCanonicalPath(final String path) {
    return (getCanonicalPath(new File(path)));
  }
  String getCanonicalPath(final File file) {
    try {
  ...
  //  public boolean onPrepareOptionsMenu(Menu menu)
  {
    ...
    menu.add(0, ACTION_THEME_SWAP, 0,
             getString(R.string.fsnavigator_change_theme)); //"Change theme");
    return (true);
  }
  //////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////
  private boolean doOptionsItem(final int itemId) {
    switch (itemId) {
