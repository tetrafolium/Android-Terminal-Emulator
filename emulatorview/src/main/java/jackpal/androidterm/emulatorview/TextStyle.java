...
final static int ciCursorForeground =
	258; // VT100 text cursor foreground color
final static int ciCursorBackground =
	259; // VT100 text cursor background color

final static int ciColorLength = ciCursorBackground + 1;

final static int kNormalTextStyle =
	encode(ciForeground, ciBackground, fxNormal);

static int encode(final int foreColor, final int backColor,
                  final int effect) {
