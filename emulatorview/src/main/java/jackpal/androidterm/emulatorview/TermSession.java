...
public class TermSession {
   ...
   */
  public void setTermOut(final OutputStream termOut) { mTermOut = termOut; }
   ...
   */
  public void setTermIn(final InputStream termIn) { mTermIn = termIn; }
   ...
   */
  protected void processInput(final byte[] data, final int offset,
                              final int count) {
   ...
   */
  protected final void appendToEmulator(final byte[] data, final int offset,
                                        final int count) {
    mEmulator.append(data, offset, count);
  }
