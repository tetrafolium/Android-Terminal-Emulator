...
public class ColorScheme {
  ...
  private void setDefaultCursorColors() {
    ...
    // Use the foreColor unless the foreColor is too similar to the
    // cursorBackColor
  ...
  private static int channelDistance(final int a, final int b,
                                     final int channel) {
   ...
   */
  public ColorScheme(final int foreColor, final int backColor,
                     final int cursorForeColor, final int cursorBackColor) {
    this.foreColor = foreColor;
    this.backColor = backColor;
   ...
   *         hex value.
   */
  public int getCursorForeColor() { return cursorForeColor; }

  /**
   * @return This <code>ColorScheme</code>'s cursor background color as an ARGB
   *         hex value.
   */
  public int getCursorBackColor() { return cursorBackColor; }
}
