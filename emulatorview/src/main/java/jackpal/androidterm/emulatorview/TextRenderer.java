 ...
 * @param lineOffset The screen character offset of this text run (0..length
 *     of line)
 * @param runWidth
 * @param text
 * @param index
 * @param count
 * @param selectionStyle True to draw the text using the "selected" style (for
 *     clipboard copy)
 * @param textStyle
 * @param cursorOffset The screen character offset of the cursor (or -1 if not
 *     on this line.)
 ...
 * @param cursorMode The cursor mode (used to show state of
 *     shift/control/alt/fn locks.
 */
void drawTextRun(Canvas canvas, float x, float y, int lineOffset,
                 ...
                 int cursorIndex, int cursorIncr, int cursorWidth,
                 int cursorMode);
}
